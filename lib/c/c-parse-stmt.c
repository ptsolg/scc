...
{
        return _c_parse_stmt(self, CSF_NONE);
}
...
extern tree_stmt* c_parse_switch_stmt(c_parser* self, int scope_flags)
{
        ...
        tree_stmt* body = _c_parse_stmt(self, scope_flags | CSF_SWITCH);
        if (!body)
                return NULL;
...
extern tree_stmt* c_parse_while_stmt(c_parser* self, int scope_flags)
{
        ...
        tree_stmt* body = _c_parse_stmt(self, scope_flags | CSF_ITERATION);
        if (!body)
                return NULL;
...
extern tree_stmt* c_parse_for_stmt(c_parser* self, int scope_flags)
{
        ...
        if (!(body = _c_parse_stmt(self, scope_flags | CSF_ITERATION)))
                return NULL;
...
extern tree_stmt* c_parse_atomic_stmt(c_parser* self, int scope_flags)
{
        ...
        tree_stmt* body = _c_parse_stmt(self, scope_flags | CSF_ATOMIC);
        if (!body)
                return NULL;
