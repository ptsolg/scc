...
static inline tree_location c_preprocessor_lexer_get_loc(const c_preprocessor_lexer* self)
{
        return self->loc;
}

static inline int c_preprocessor_lexer_get_prevc(const c_preprocessor_lexer* self)
{
        return self->chars[0];
}

static inline int c_preprocessor_lexer_getc(const c_preprocessor_lexer* self)
{
        return self->chars[1];
}

static inline int c_preprocessor_lexer_get_nextc(const c_preprocessor_lexer* self)
{
        return self->chars[2];
}
...
static inline bool c_preprocessor_lexer_at_start_of_line(const c_preprocessor_lexer* self)
{
        return c_preprocessor_lexer_get_prevc(self) == '\n';
}

static inline void c_preprocessor_lexer_shift_buf(c_preprocessor_lexer* self, int c)
{
...
static inline int c_preprocessor_lexer_readc(c_preprocessor_lexer* self)
{
        c_preprocessor_lexer_shift_buf(self, readbuf_readc(self->buf));
        if (c_preprocessor_lexer_getc(self) == '\\'
                && char_is_newline(c_preprocessor_lexer_get_nextc(self)))
        {
...
static inline bool c_sequence_append(c_sequence* self, const c_preprocessor_lexer* lexer, int c)
{
...
static tree_id c_preprocessor_lexer_get_sequence_id(c_preprocessor_lexer* self, c_sequence* seq)
{
...
static bool c_preprocessor_lexer_read_word_sequence(c_preprocessor_lexer* self, c_sequence* seq)
{
        seq->loc = c_preprocessor_lexer_get_loc(self);
        int c = c_preprocessor_lexer_getc(self);
        while (get_char_info(c) & (ACK_ALPHA | ACK_DIGIT))
        {
                if (!c_sequence_append(seq, self, c))
                        return false;

                c = c_preprocessor_lexer_readc(self);
        }
...
extern c_token* c_preprocessor_lexer_lex_identifier(c_preprocessor_lexer* self)
{
        ...
        if (!c_preprocessor_lexer_read_word_sequence(self, &word))
                return NULL;

        return c_token_new_id(self->context,
                word.loc, c_preprocessor_lexer_get_sequence_id(self, &word));
}

static bool c_preprocessor_lexer_read_quoted_sequence(
        c_preprocessor_lexer* self, c_sequence* seq, int quote)
{
        seq->loc = c_preprocessor_lexer_get_loc(self);
        bool consume = false;
        while (1)
        {
                int c = c_preprocessor_lexer_readc(self);
                if (char_is_newline(c) || c_preprocessor_lexer_at_eof(self))
                {
...
extern c_token* c_preprocessor_lexer_lex_string_literal(c_preprocessor_lexer* self)
{
        ...
        if (!c_preprocessor_lexer_read_quoted_sequence(self, &schar, '"'))
                return NULL;

        return c_token_new_string(self->context,
                schar.loc, c_preprocessor_lexer_get_sequence_id(self, &schar));
}
...
extern c_token* c_preprocessor_lexer_lex_angle_string_literal(c_preprocessor_lexer* self)
{
        c_sequence seq;
        c_sequence_init(&seq);
        if (!c_preprocessor_lexer_read_quoted_sequence(self, &seq, '>'))
                return NULL;

        return c_token_new_angle_string(self->context,
                seq.loc, c_preprocessor_lexer_get_sequence_id(self, &seq));
}
...
extern c_token* c_preprocessor_lexer_lex_character_constant(c_preprocessor_lexer* self)
{
        ...
        if (!c_preprocessor_lexer_read_quoted_sequence(self, &cchar, '\''))
                return NULL;
...
static bool c_preprocessor_lexer_read_number_sequence(c_preprocessor_lexer* self, c_sequence* seq)
{
        seq->loc = c_preprocessor_lexer_get_loc(self);
        int c = c_preprocessor_lexer_getc(self);
        while (1)
...
static c_token* c_preprocessor_lexer_lex_comment(c_preprocessor_lexer* self)
{
        tree_location loc = c_preprocessor_lexer_get_loc(self);
        int c = c_preprocessor_lexer_readc(self); // '/'
        if (c == '/')
        {
                while (!char_is_newline(c) && !c_preprocessor_lexer_at_eof(self))
                        c = c_preprocessor_lexer_readc(self);
        }
        else
        {
                ...
                {
                        c = c_preprocessor_lexer_readc(self);
                        if (c == '/' && c_preprocessor_lexer_get_prevc(self) == '*')
                        {
                                c_preprocessor_lexer_readc(self); // '/'
                                break;
                        }
...
static inline c_token_kind _c_preprocessor_lexer_lex_punctuator(c_preprocessor_lexer* self)
{
        switch ((char)c_preprocessor_lexer_getc(self))
        {
                case '{': c_preprocessor_lexer_readc(self); return CTK_LBRACE;
                case '}': c_preprocessor_lexer_readc(self); return CTK_RBRACE;
                case '[': c_preprocessor_lexer_readc(self); return CTK_LSBRACKET;
                case ']': c_preprocessor_lexer_readc(self); return CTK_RSBRACKET;
                case '(': c_preprocessor_lexer_readc(self); return CTK_LBRACKET;
                case ')': c_preprocessor_lexer_readc(self); return CTK_RBRACKET;
                case ':': c_preprocessor_lexer_readc(self); return CTK_COLON;
                case '?': c_preprocessor_lexer_readc(self); return CTK_QUESTION;
                case ',': c_preprocessor_lexer_readc(self); return CTK_COMMA;
                case '~': c_preprocessor_lexer_readc(self); return CTK_TILDE;
                case ';': c_preprocessor_lexer_readc(self); return CTK_SEMICOLON;

                case '.':
                        c_preprocessor_lexer_readc(self);
                        if (c_preprocessor_lexer_getc(self) == '.')
                        {
                                if (c_preprocessor_lexer_get_nextc(self) == '.')
                                {
                                        c_preprocessor_lexer_readc(self);
                                        c_preprocessor_lexer_readc(self);
                                        return CTK_ELLIPSIS;
                ...
                case '-':
                        c_preprocessor_lexer_readc(self);
                        switch (c_preprocessor_lexer_getc(self))
                        {
                                case '>': c_preprocessor_lexer_readc(self); return CTK_ARROW;
                                case '=': c_preprocessor_lexer_readc(self); return CTK_MINUS_EQ;
                                case '-': c_preprocessor_lexer_readc(self); return CTK_MINUS2;
                ...
                case '<':
                        ...
                        else if (c_preprocessor_lexer_getc(self) == '=')
                        {
                                c_preprocessor_lexer_readc(self);
                                return CTK_LEQ;
                        }
                ...
                case '&':
                        ...
                        switch (c_preprocessor_lexer_getc(self))
                        {
                                case '&': c_preprocessor_lexer_readc(self); return CTK_AMP2;
                                case '=': c_preprocessor_lexer_readc(self); return CTK_AMP_EQ;
                ...
                case '|':
                        ...
                        switch (c_preprocessor_lexer_getc(self))
                        {
                                case '|': c_preprocessor_lexer_readc(self); return CTK_VBAR2;
                                case '=': c_preprocessor_lexer_readc(self); return CTK_VBAR_EQ;
                ...
                case '+':
                        ...
                        switch (c_preprocessor_lexer_getc(self))
                        {
                                case '+': c_preprocessor_lexer_readc(self); return CTK_PLUS2;
                                case '=': c_preprocessor_lexer_readc(self); return CTK_PLUS_EQ;
...
{
        tree_location loc = c_preprocessor_lexer_get_loc(self);
        c_token_kind k = _c_preprocessor_lexer_lex_punctuator(self);
        if (k == CTK_UNKNOWN)
        {
                c_error_unknown_punctuator(self->logger, loc, c_preprocessor_lexer_getc(self));
                return NULL;
        }
        return c_token_new(self->context, k, loc);
}

static c_token* c_preprocessor_lexer_lex_symbols(c_preprocessor_lexer* self)
{
        int c = c_preprocessor_lexer_getc(self);
        if (c == '\"')
                return c_preprocessor_lexer_lex_string_literal(self);
        else if (c == '\'')
                return c_preprocessor_lexer_lex_character_constant(self);
        else if (c == '<' && self->angle_string_expected)
                return c_preprocessor_lexer_lex_angle_string_literal(self);

        int next = c_preprocessor_lexer_get_nextc(self);
        if (c == '.' && char_is_digit(next))
                return c_preprocessor_lexer_lex_number(self);
        else if (c == '/' && (next == '/' || next == '*'))
                return c_preprocessor_lexer_lex_comment(self);

        return c_preprocessor_lexer_lex_punctuator(self);
}

static c_token* c_preprocessor_lexer_lex_wspace(c_preprocessor_lexer* self)
{
        tree_location loc = c_preprocessor_lexer_get_loc(self);
        int spaces = 0;
        int c = c_preprocessor_lexer_getc(self);
        while (char_is_wspace(c) && !c_preprocessor_lexer_at_eof(self))
        {
...
extern c_token* c_preprocessor_lexer_lex_token(c_preprocessor_lexer* self)
{
        ...
        if (i & ACK_ALPHA)
                return c_preprocessor_lexer_lex_identifier(self);
        else if (i & ACK_SYMBOL)
                return c_preprocessor_lexer_lex_symbols(self);
        else if (i & ACK_DIGIT)
                return c_preprocessor_lexer_lex_number(self);
        else if (i & ACK_WSPACE)
                return c_preprocessor_lexer_lex_wspace(self);
