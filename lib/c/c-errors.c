...
extern void c_error_unterminated_macro_argument_list(c_logger* self, c_macro* macro, tree_location loc)
{
        ...
        c_error(self, CEEC_ERROR, loc, "unterminated argument list invoking macro '%s'", macro_name);
}

extern void c_error_macro_argument_list_underflow(c_logger* self, c_macro* macro, size_t args_given, tree_location loc)
{
        const char* macro_name = tree_get_id_string(self->tree, macro->name);
        c_error(self, CEEC_ERROR, loc, "macro '%s' requires %u arguments, but only %u given",
...
{
        const char* macro_name = tree_get_id_string(self->tree, macro->name);
        c_error(self, CEEC_ERROR, loc, "macro '%s' passed %u arguments, but takes just %u",
        ...
        c_logger* self, tree_location loc, c_token_kind a, c_token_kind b)
{
        ...
        c_error(self, CEEC_ERROR, loc, "expected %s before %s %s",
        ...
        c_logger* self, tree_location loc, c_token_kind a, c_token_kind b, c_token_kind c)
{
        ...
        c_error(self, CEEC_ERROR, loc, "expected %s or %s before %s %s",
...
{       
        c_error(self, CEEC_ERROR, d->name_loc, "invalid storage class for parameter '%s'",
...
{
        c_error(self, CEEC_ERROR, tree_get_decl_loc_begin(func),
...
{
        c_error(self, CEEC_ERROR, tree_get_expr_loc(init), "invalid initializer");
}
...
extern void c_error_initialization_discards_qualifer(c_logger* self, const tree_expr* init, int quals)
{
        ...
        c_error(self, CEEC_ERROR, tree_get_expr_loc(init),
...
{
        c_error(self, CEEC_ERROR, loc, "braces around scalar initializer");
}

extern void c_error_field_name_not_in_record_initializer(c_logger* self, const tree_designator* d)
{
        c_error(self, CEEC_ERROR, tree_get_designator_loc(d),
...
{
        c_error(self, CEEC_ERROR, tree_get_designator_loc(d), "array index in non-array initializer");
}

extern void c_error_array_index_in_initializer_not_of_integer_type(c_logger* self, const tree_expr* index)
{
        c_error(self, CEEC_ERROR, tree_get_expr_loc(index),
...
{
        c_error(self, CEEC_ERROR, tree_get_expr_loc(index), "nonconstant array index in initializer");
}
...
{
        c_error(self, CEEC_ERROR, tree_get_expr_loc_begin(init), "initializer element is not constant");
}

extern void c_error_named_argument_before_ellipsis_required(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "ISO C requires a named argument before '...'");
}

extern void c_error_redefinition(c_logger* self, tree_location loc, tree_id id)
{
        c_error(self, CEEC_ERROR, loc, "redefinition of '%s'", tree_get_id_string(self->tree, id));
}
...
{
        c_error(self, CEEC_ERROR, loc, "enumerator value for '%s' is not an integer constant",
                tree_get_id_string(self->tree, name));
}

extern void c_error_wrong_king_of_tag(c_logger* self, tree_location loc, tree_id name)
{
        c_error(self, CEEC_ERROR, loc, "'%s' defined as wrong kind of tag",
                tree_get_id_string(self->tree, name));
}

static void c_error_decl(c_logger* self, const char* msg, const tree_decl* decl)
{
        c_error(self, CEEC_ERROR, tree_get_decl_loc_begin(decl), msg,
...
{
        c_error(self, CEEC_ERROR, tree_get_decl_loc_begin(param), "parameter name omitted");
}
...
{
        c_error(self, CEEC_ERROR, tree_get_expr_loc(e), "expression must be a modifiable lvalue");
}

extern void c_error_types_are_not_compatible(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "types are not compatible");
}

extern void c_error_subscripted_value_isnt_array(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "subscripted value is not array, pointer, or vector");
}
...
{
        c_error(self, CEEC_ERROR, tree_get_expr_loc(call), 
...
{
        c_error(self, CEEC_ERROR, loc, "operand of sizeof may not be a function");
}

extern void c_error_operand_of_sizeof_is_bitfield(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "operand of sizeof may not be a bitfield");
}
...
{
        c_error(self, CEEC_ERROR, loc, "comparison of distinct pointer types");
}
...
extern void c_error_assignment_discards_quals(c_logger* self, tree_location loc, int quals)
{
        char qstring[128];
        c_qet_qual_string(quals, qstring);
        c_error(self, CEEC_ERROR, loc, "assignment discards '%s' qualifier", qstring);
}

extern void c_error_assignment_from_incompatible_pointer_type(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "assignment from incompatible pointer type");
}

extern void c_error_pointer_type_mismatch(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "pointer type mismatch in conditional expression");
}

extern void c_error_type_mismatch(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "type mismatch in conditional expression");
}

extern void c_error_case_stmt_outside_switch(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "a case statement may only be used within a switch");
}

extern void c_error_case_stmt_isnt_constant(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "case label does not reduce to an integer constant");
}

extern void c_error_case_stmt_duplication(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "duplicate case value");
}

extern void c_error_default_stmt_outside_switch(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "a default statement may only be used within a switch");
}

extern void c_error_default_stmt_duplication(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "multiple default labels in one switch");
}
...
{
        c_error(self, CEEC_ERROR, tree_get_expr_loc(expr),
...
extern void c_error_return_discards_quals(c_logger* self, tree_location loc, int quals)
{
        char qstring[128];
        c_qet_qual_string(quals, qstring);
        c_error(self, CEEC_ERROR, loc, "return discards '%s' qualifier", qstring);
}

extern void c_error_return_from_incompatible_pointer_type(c_logger* self, tree_location loc)
{
        c_error(self, CEEC_ERROR, loc, "return from incompatible pointer type");
}

static void c_error_stmt(c_logger* self, const char* msg, const tree_stmt* stmt)
{
        c_error(self, CEEC_ERROR, tree_get_stmt_loc(stmt).begin, msg);
}
