        ...
        const c_decl_specs* specs, const c_declarator* d, tree_decl_kind dk, bool has_body_or_init)
{
        ...
        {
                c_error_invalid_specifier(self->ccontext, name_loc, "inline", TDK_FUNCTION);
                return false;
        }
        ...
        if (sd == TSD_THREAD)
        {
                if (dk != TDK_VAR)
                {
                        c_error_invalid_specifier(self->ccontext, name_loc, "_Thread_local", TDK_VAR);
                        return false;
                }
        ...
        if (sc == TSC_REGISTER)
        {
                if (dk != TDK_VAR)
                {
                        c_error_invalid_specifier(self->ccontext, name_loc, "register", TDK_VAR);
                        return false;
                }
